...
function setTime() {
  ...
  startQuiz.addEventListener("click", function() {
    ...
    questDiv[i].addEventListener("click", function() {
      ...
      //   questD.textContent = "D. " + questions[0].choices[3];
        ...
        // if (questB.textContent = "B. " + questions[0].answer) {
        //   console.log("false");
        //   console.log(questB.textContent);
  ...
  //   if (questD.textContent === "D. " + questions[1].answer) {
  ...
  //     if (questA.textContent === "A. " + questions[2].answer) {
  //       questA.addEventListener("click", function() {
  ...
  //         if (questB.textContent === "B. " + questions[3].answer) {
  //           questB.addEventListener("click", function() {
          
              
          
  //             testDiv.textContent = questions[4].title;
  //             questA.textContent = "A. " + questions[4].choices[0];
  //             questB.textContent = "B. " + questions[4].choices[1];
  //             questC.textContent = "C. " + questions[4].choices[2];
  //             questD.textContent = "D. " + questions[4].choices[3];

  //             if (questC.textContent === "C. " + questions[4].answer) {
...
// if (questA.textContent === questions[0].answer) {
//   questA.addEventListener("click", function() {
